...
<div class = "container">
    ...
    $json = file_get_contents('https://euw.api.pvp.net/api/lol/euw/v2.5/league/challenger?type=RANKED_SOLO_5x5&api_key=c453691a-d560-4db6-9cbb-f7a7b6d1ee06');
...
<style>
    body {
        ...
        background-image: linear-gradient(to bottom, rgba(0,0,0,0.6) 0%,rgba(0,0,0,0.6) 100%), url("http://ddragon.leagueoflegends.com/cdn/img/champion/splash/Aatrox_1.jpg");
        background-size: 100%;
</style>
